...
class Event(models.Model):
    ...
    AgeCategory = models.ForeignKey('AgeCategory', on_delete=models.CASCADE, null=True)
    EventCategory = models.ForeignKey('EventCategory', on_delete=models.CASCADE, null=True)
